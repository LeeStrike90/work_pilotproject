...
<body>
	...
	<form id="frm">
		...
		</label> <br> <label> 내용<input type="text" name="bookComent"
			required placeholder="책의 간략한 내용을 입력하세요">
		</label> <br> <label> 작가<input type="text" name="bookWrite"
			required placeholder="작가 이름을 입력하세요">
		</label> <br> <label> 출판사<input type="text" name="bookPub"
			required placeholder="출판사 이름을 입력하세요">
		</label> <br> <label> 발행일<input type="date" name="bookDate"
			required>
		</label> <br>
		<!-- 대분류 선택 -->
		...
		</label> <br> <label> 재고<input type="number" name="bookCount"
