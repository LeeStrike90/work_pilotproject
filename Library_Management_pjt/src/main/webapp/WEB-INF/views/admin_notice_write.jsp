...
<link rel="stylesheet" type="text/css"
	href="/pilotpjt/resources/css/admin_notice_write.css">
...
<body>
	...
	<div class="container">
		<div class="notice-form">
			...
			<form action="/pilotpjt/notice_write" method="POST"
				...
				<div class="form-group">
					<label for="category" class="form-label">카테고리</label> <select
						id="category" name="noticeCategory" class="form-select" required>
				...
				<div class="form-group">
					<label for="title" class="form-label">제목</label> <input type="text"
						id="title" name="noticeTitle" class="form-input"
				...
				<div class="form-actions">
					<button type="button" class="action-btn cancel-btn"
						onclick="location.href='admin_notice'">
