...
<link rel="stylesheet" type="text/css"
	href="/pilotpjt/resources/css/board_view.css">
<link rel="stylesheet"
	...
	<div class="board-container">
		<div class="board-header">
			...
			<div class="board-actions">
				...
				<button class="write-button"
					onclick="location.href='/pilotpjt/board_write'">
			...
			<tbody>
				...
				<c:forEach items="${boardList}" var="board">
					<tr>
						...
						<td class="board-title-col"><a
							href="board_detail_view?boardNumber=${board.boardNumber}"
							class="title-link">${board.boardTitle}</a></td>
		...
		<div class="pagination">
			<c:if test="${currentPage > 1}">
				<div class="page-item">
					<a href="/pilotpjt/board_view?page=${currentPage - 1}"
